...
async def handle_reply_buttons(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == MGMT_BTN:
        ...
        await update.message.reply_text("👥 Yönetim Paneli", reply_markup=InlineKeyboardMarkup(kb))
        return
    ...
    if text == CONTENT_BTN:
        ...
        await update.message.reply_text("📁 İçerik Yönetimi", reply_markup=InlineKeyboardMarkup(kb))
        return
