...
async def handle_any_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_admin(uid) and is_main_admin(uid) is False:
        # Diğer adminler için de AI çalışacak ama log yapılmıyor
        pass
    if is_main_admin(uid): pass  # süper admin için de AI açık
